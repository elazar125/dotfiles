...
vim.api.nvim_set_hl(0, 'SignColumn', { fg = colours.gui03, bg = colours.gui01, ctermfg = colours.cterm03, ctermbg = colours.cterm01 })
...
vim.api.nvim_set_hl(0, 'VertSplit', { fg = colours.gui02, bg = colours.gui02, ctermfg = colours.cterm02, ctermbg = colours.cterm02 })
