...
font_blue="\[\e[38;5;4m\]"
font_purple_="\[\e[38;5;5m\]"
font_cyan_="\[\e[38;5;6m\]"
font_white="\[\e[38;5;7m\]"
font_grey="\[\e[38;5;8m\]"
font_light_red_="\[\e[38;5;9m\]"
font_light_green_="\[\e[38;5;10m\]"
font_light_yellow_="\[\e[38;5;11m\]"
font_light_blue_="\[\e[38;5;12m\]"
font_light_purple_="\[\e[38;5;13m\]"
...
directory="$font_cyan_ \w"
time="$font_red \A"
message="$reset\n├ $font_light_yellow_\$picked_message"
prompt="$reset\n╰   "

left="$reset\n╭ $time $directory"
right="$message$prompt"
format=" $font_light_blue_ %s"
